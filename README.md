...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-phalcon.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-phalcon)
...
```bash
php artisan vendor:publish --tag="laravel-phalcon-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-phalcon-views"
```

## Usage

```php
$laravelPhalcon = new Vahalik\LaravelPhalcon();
echo $laravelPhalcon->echoPhrase('Hello, Vahalik!');
```
